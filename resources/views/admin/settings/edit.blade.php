            ...
            <div class="px-6 py-5">
                <form method="POST" action="{{ route('admin.settings.toggle-voting') }}">
                    ...
                    <div class="flex items-start gap-4 p-4 rounded-xl
                        ...
                        <div class="flex-1">
                            <p class="text-sm font-semibold {{ $settings->voting_open ? 'text-emerald-800' : 'text-red-700' }}">
                                {{ $settings->voting_open
            ...
            <div class="px-6 py-5 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    ...
                    <p class="text-xs text-gray-500 mt-0.5">
                        ...
                        <span class="font-semibold {{ $settings->results_published ? 'text-emerald-600' : 'text-gray-500' }}">
