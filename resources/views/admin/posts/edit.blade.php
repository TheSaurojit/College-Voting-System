...
@section('subtitle', 'Update election post details')
    ...
    <div class="max-w-2xl">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            <div class="px-6 py-5 border-b border-gray-100">
                ...
                <p class="text-sm text-gray-500 mt-1">Update the post/position details below.</p>
            </div>

            <form method="POST" action="{{ route('admin.posts.update', $post) }}" class="p-6 space-y-5">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    <input type="number" id="display_order" name="display_order" value="{{ old('display_order', $post->display_order) }}" min="0" class="w-full px-4 py-3 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all duration-200" placeholder="0">
