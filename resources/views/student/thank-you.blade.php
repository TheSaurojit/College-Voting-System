    ...
    <div class="max-w-2xl mx-auto">
        ...
        <div class="relative">
            ...
            <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-gray-200/50 overflow-hidden">
                ...
                {{-- Vote Summary --}}
                <div class="p-6">
                    <h2 class="text-lg font-bold text-gray-900 mb-4">Your Vote Summary</h2>

                    <div class="space-y-3">
                        @forelse($votes as $vote)
                            <div class="flex items-center gap-4 p-4 bg-gray-50 rounded-xl border border-gray-100">
                                <div class="w-10 h-10 rounded-lg bg-gradient-to-br from-indigo-500 to-violet-600 flex items-center justify-center text-white shrink-0">
                                ...
                                <div class="flex-1 min-w-0">
                                    <p class="text-xs font-semibold text-gray-400 uppercase tracking-wider">{{ $vote->post->name ?? 'Post' }}</p>
                                    <p class="text-sm font-bold text-gray-900 truncate">{{ $vote->candidate->name ?? 'Candidate' }}</p>
                                </div>
                                <div class="shrink-0">
